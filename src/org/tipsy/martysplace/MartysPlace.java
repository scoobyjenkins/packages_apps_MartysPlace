...
@SearchIndexable
public class MartysPlace extends SettingsPreferenceFragment implements Indexable {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        addPreferencesFromResource(R.xml.tipsy_main_menu);
    ...
    public void onCreateOptionsMenu(Menu menu, MenuInflater inflater) {
        menu.add(0, MENU_HELP, 0, R.string.martysplace_dialog_title)
                .setIcon(R.drawable.ic_martysplace_info)
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case MENU_HELP:
                ...
                (R.string.martysplace_dialog_toast),
    ...
    public static class MyAlertDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(Bundle savedInstanceState) {
            return new AlertDialog.Builder(getActivity())
                .setTitle(R.string.martysplace_dialog_title)
                .setMessage(R.string.martysplace_dialog_message)
                .setCancelable(false)
    ...
    public static final Indexable.SearchIndexProvider SEARCH_INDEX_DATA_PROVIDER =
            new BaseSearchIndexProvider() {
                ...
                public List<SearchIndexableResource> getXmlResourcesToIndex(Context context,
                    ...
                    sir.xmlResId = R.xml.tipsy_main_menu;
                    result.add(sir);
                    return result;
                }
